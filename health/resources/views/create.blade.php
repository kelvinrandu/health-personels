...
<div class="col-md-6 ">
    <div class="portlet light ">
        ...
        <div class="portlet-body form">
            <form class="form-horizontal" role="form" action="{{ route('create.record') }}" method="post" > 
            {{csrf_field()}}
                <div class="form-body">
                    <div class="form-group">
                        <label class="col-md-3 control-label">Professional Name</label>
                        <div class="col-md-9">
                            <input type="text" name="professional_name" class="form-control" placeholder="Enter full names">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="workstation" class="form-control" placeholder="Enter workstation">
